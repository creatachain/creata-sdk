...
import (
	...
	amino "github.com/creatachain/go-amino"
...
// RegisterEvidences registers Augusteum evidence types with the provided Amino
// codec.
func RegisterEvidences(cdc *LegacyAmino) {
	cdc.Amino.RegisterInterface((*tmtypes.Evidence)(nil), nil)
	cdc.Amino.RegisterConcrete(&tmtypes.DuplicateVoteEvidence{}, "augusteum/DuplicateVoteEvidence", nil)
}
