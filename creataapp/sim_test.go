...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewCreataApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, FlagPeriodValue, MakeTestEncodingConfig(), EmptyAppOptions{}, fauxMerkleModeOpt)
	require.Equal(t, "CreataApp", app.Name())
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewCreataApp(log.NewNopLogger(), newDB, nil, true, map[int64]bool{}, DefaultNodeHome, FlagPeriodValue, MakeTestEncodingConfig(), EmptyAppOptions{}, fauxMerkleModeOpt)
	require.Equal(t, "CreataApp", newApp.Name())
	...
	storeKeysPrefixes := []StoreKeysPrefixes{
		...
		{app.keys[icphost.StoreKey], newApp.keys[icphost.StoreKey], [][]byte{}},
		{app.keys[icptransfertypes.StoreKey], newApp.keys[icptransfertypes.StoreKey], [][]byte{}},
	}
...
func TestAppSimulationAfterImport(t *testing.T) {
	...
	newApp.InitChain(msm.RequestInitChain{
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numSeeds; i++ {
		...
		for j := 0; j < numTimesToRunPerSeed; j++ {
			...
			db := dbm.NewMemDB()
			app := NewCreataApp(logger, db, nil, true, map[int64]bool{}, DefaultNodeHome, FlagPeriodValue, MakeTestEncodingConfig(), EmptyAppOptions{}, interBlockCacheOpt())
