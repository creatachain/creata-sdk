...
// Context. The server Augusteum configuration will either be read and parsed
// or created and saved to disk, where the server Context is updated to reflect
// the Augusteum configuration. The Viper literal is used to read and parse
// the application configuration. Command handlers can fetch the server Context
// to get the Augusteum configuration or to get access to Viper.
func InterceptConfigsPreRunHandler(cmd *cobra.Command) error {
	...
	// return value is a augusteum configuration object
...
// interceptConfigs parses and updates a Augusteum configuration file or
// creates a new one and saves it. It also parses and saves the application
// configuration file. The Augusteum configuration file is parsed given a root
...
func AddCommands(rootCmd *cobra.Command, defaultNodeHome string, appCreator types.AppCreator, appExport types.AppExporter, addStartFlags types.ModuleInitFlags) {
	augusteumCmd := &cobra.Command{
		Use:   "augusteum",
		Short: "Augusteum subcommands",
	}

	augusteumCmd.AddCommand(
		ShowNodeIDCmd(),
		ShowValidatorCmd(),
		ShowAddressCmd(),
		VersionCmd(),
