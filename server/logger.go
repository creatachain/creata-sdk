...
// Augusteum's Logger interface.
type ZeroLogWrapper struct {
	zerolog.Logger
}

// Info implements Augusteum's Logger interface and logs with level INFO. A set
...
// Error implements Augusteum's Logger interface and logs with level ERR. A set
// of key/value tuples may be provided to add context to the log. The number of
// tuples must be even and the key of the tuple must be a string.
...
// Debug implements Augusteum's Logger interface and logs with level DEBUG. A set
// of key/value tuples may be provided to add context to the log. The number of
// tuples must be even and the key of the tuple must be a string.
