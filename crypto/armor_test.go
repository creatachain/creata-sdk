...
import (
	...
	"github.com/creatachain/augusteum/crypto/armor"
	"github.com/creatachain/augusteum/crypto/xsalsa20symmetric"
	"github.com/creatachain/crypto/bcrypt"
	"github.com/stretchr/testify/require"

	"github.com/creatachain/creata-sdk/codec/legacy"
	"github.com/creatachain/creata-sdk/crypto"
...
func TestArmorUnarmorPrivKey(t *testing.T) {
	...
	armored = armor.EncodeArmor("AUGUSTEUM PRIVATE KEY", headerWrongKdf, encBytes)
	_, _, err = crypto.UnarmorDecryptPrivKey(armored, "passphrase")
	require.Error(t, err)
...
func TestArmorUnarmorPubKey(t *testing.T) {
	...
	require.Error(t, err)
	require.Equal(t, `couldn't unarmor bytes: unrecognized armor type "AUGUSTEUM PRIVATE KEY", expected: "AUGUSTEUM PUBLIC KEY"`, err.Error())
	...
	armored = armor.EncodeArmor("AUGUSTEUM PUBLIC KEY", header, pubBytes)
...
func TestUnarmorInfoBytesErrors(t *testing.T) {
	...
	unarmoredBytes, err = crypto.UnarmorInfoBytes(armor.EncodeArmor(
		"AUGUSTEUM KEY INFO", header, []byte("plain-text")))
	require.Error(t, err)
