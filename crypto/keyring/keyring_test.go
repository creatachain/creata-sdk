...
func TestNewKeyring(t *testing.T) {
	...
	kr, err := New("creata", BackendFile, dir, mockIn)
	require.NoError(t, err)

	nilKr, err := New("creata", "fuzzy", dir, mockIn)
	require.Error(t, err)
	require.Nil(t, nilKr)
...
func TestKeyManagementKeyRing(t *testing.T) {
	...
	require.NoError(t, err)
	addr, err := sdk.AccAddressFromBech32("creata1yq8lgssgxlx9smjhes6ryjasmqmd3ts2559g0t")
	require.NoError(t, err)
