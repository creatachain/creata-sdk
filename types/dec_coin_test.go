...
func (s *decCoinTestSuite) TestParseDecCoins() {
	testCases := []struct {
		...
		{"", nil, false},
		{"4fcta", sdk.DecCoins{sdk.NewDecCoinFromDec("ucta", sdk.NewDecFromInt(sdk.NewInt(4)))}, false},
		{"5.5cta,4fcta", sdk.DecCoins{
			sdk.NewDecCoinFromDec("cta", sdk.NewDecWithPrec(5500000000000000000, sdk.Precision)),
			sdk.NewDecCoinFromDec("ucta", sdk.NewDec(4)),
		}, false},
		{"0.0fcta", sdk.DecCoins{}, false}, // remove zero coins
		{"10.0btc,1.0cta,20.0btc", nil, true},
		{
			"0.004STAKE",
		...
		{
			"0.004fcta",
			sdk.DecCoins{sdk.NewDecCoinFromDec("ucta", sdk.NewDecWithPrec(4000000000000000, sdk.Precision))},
			false,
		},
		{
			"5.04cta,0.004fcta",
			sdk.DecCoins{
				sdk.NewDecCoinFromDec("cta", sdk.NewDecWithPrec(5040000000000000000, sdk.Precision)),
				sdk.NewDecCoinFromDec("ucta", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
			false,
		},
		{"0.0fcta,0.004fcta,5.04cta", // remove zero coins
			sdk.DecCoins{
				sdk.NewDecCoinFromDec("cta", sdk.NewDecWithPrec(5040000000000000000, sdk.Precision)),
				sdk.NewDecCoinFromDec("ucta", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
...
func (s *decCoinTestSuite) TestDecCoinsString() {
	testCases := []struct {
		...
		{sdk.DecCoins{}, ""},
		{
			...
			"5.040000000000000000cta,0.004000000000000000fcta",
		},
	}
...
func (s *decCoinTestSuite) TestDecCoinsIntersect() {
	testCases := []struct {
		...
		{"", "", ""},
		{"1.0fcta", "", ""},
		{"1.0fcta", "1.0fcta", "1.0fcta"},
		{"", "1.0fcta", ""},
		{"1.0fcta", "", ""},
		{"2.0fcta,1.0trope", "1.9fcta", "1.9fcta"},
		{"2.0fcta,1.0trope", "2.1fcta", "2.0fcta"},
		{"2.0fcta,1.0trope", "0.9trope", "0.9trope"},
		{"2.0fcta,1.0trope", "1.9fcta,0.9trope", "1.9fcta,0.9trope"},
		{"2.0fcta,1.0trope", "1.9fcta,0.9trope,20.0other", "1.9fcta,0.9trope"},
		{"2.0fcta,1.0trope", "1.0other", ""},
	}
