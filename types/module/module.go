...
type AppModuleGenesis interface {
	...
	InitGenesis(sdk.Context, codec.JSONMarshaler, json.RawMessage) []msm.ValidatorUpdate
...
type AppModule interface {
	...
	// MSM
	BeginBlock(sdk.Context, msm.RequestBeginBlock)
	EndBlock(sdk.Context, msm.RequestEndBlock) []msm.ValidatorUpdate
}
...
func (gam GenesisOnlyAppModule) BeginBlock(ctx sdk.Context, req msm.RequestBeginBlock) {}

// EndBlock returns an empty module end-block
func (GenesisOnlyAppModule) EndBlock(_ sdk.Context, _ msm.RequestEndBlock) []msm.ValidatorUpdate {
...
func (m *Manager) InitGenesis(ctx sdk.Context, cdc codec.JSONMarshaler, genesisData map[string]json.RawMessage) msm.ResponseInitChain {
	var validatorUpdates []msm.ValidatorUpdate
...
// modules.
func (m *Manager) BeginBlock(ctx sdk.Context, req msm.RequestBeginBlock) msm.ResponseBeginBlock {
...
// child context with an event manager to aggregate events emitted from all
// modules.
func (m *Manager) EndBlock(ctx sdk.Context, req msm.RequestEndBlock) msm.ResponseEndBlock {
	ctx = ctx.WithEventManager(sdk.NewEventManager())
