...
// source: creata/base/msm/v1beta1/msm.proto

package types

import (
	fmt "fmt"
	types1 "github.com/creatachain/augusteum/msm/types"
...
type TxResponse struct {
	...
	Logs MSMMessageLogs `protobuf:"bytes,7,rep,name=logs,proto3,castrepeated=MSMMessageLogs" json:"logs"`
...
func (*TxResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{0}
}
...
// MSMMessageLog defines a structure containing an indexed tx MSM message log.
type MSMMessageLog struct {
...
func (m *MSMMessageLog) Reset()      { *m = MSMMessageLog{} }
func (*MSMMessageLog) ProtoMessage() {}
func (*MSMMessageLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{1}
}
func (m *MSMMessageLog) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MSMMessageLog) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MSMMessageLog.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MSMMessageLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MSMMessageLog.Merge(m, src)
}
func (m *MSMMessageLog) XXX_Size() int {
	return m.Size()
}
func (m *MSMMessageLog) XXX_DiscardUnknown() {
	xxx_messageInfo_MSMMessageLog.DiscardUnknown(m)
}

var xxx_messageInfo_MSMMessageLog proto.InternalMessageInfo

func (m *MSMMessageLog) GetMsgIndex() uint32 {
	if m != nil {
		return m.MsgIndex
	}
	return 0
...
func (m *MSMMessageLog) GetLog() string {
	if m != nil {
		return m.Log
	}
	return ""
...
func (m *MSMMessageLog) GetEvents() StringEvents {
	if m != nil {
		return m.Events
	}
	return nil
...
func (*StringEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{2}
}
...
func (*Attribute) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{3}
}
...
func (*GasInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{4}
}
...
func (*Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{5}
}
...
func (*SimulationResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{6}
}
...
func (*MsgData) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{7}
}
...
func (*TxMsgData) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{8}
}
...
func (*SearchTxsResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d01af54c87066be, []int{9}
}
...
func init() {
	proto.RegisterType((*TxResponse)(nil), "creata.base.msm.v1beta1.TxResponse")
	proto.RegisterType((*MSMMessageLog)(nil), "creata.base.msm.v1beta1.MSMMessageLog")
	proto.RegisterType((*StringEvent)(nil), "creata.base.msm.v1beta1.StringEvent")
	proto.RegisterType((*Attribute)(nil), "creata.base.msm.v1beta1.Attribute")
	proto.RegisterType((*GasInfo)(nil), "creata.base.msm.v1beta1.GasInfo")
	proto.RegisterType((*Result)(nil), "creata.base.msm.v1beta1.Result")
	proto.RegisterType((*SimulationResponse)(nil), "creata.base.msm.v1beta1.SimulationResponse")
	proto.RegisterType((*MsgData)(nil), "creata.base.msm.v1beta1.MsgData")
	proto.RegisterType((*TxMsgData)(nil), "creata.base.msm.v1beta1.TxMsgData")
	proto.RegisterType((*SearchTxsResult)(nil), "creata.base.msm.v1beta1.SearchTxsResult")
}

func init() { proto.RegisterFile("creata/base/msm/v1beta1/msm.proto", fileDescriptor_1d01af54c87066be) }

var fileDescriptor_1d01af54c87066be = []byte{
	// 922 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *TxResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Timestamp) > 0 {
		...
		i = encodeVarintMsm(dAtA, i, uint64(len(m.Timestamp)))
		i--
		dAtA[i] = 0x62
	}
	if m.Tx != nil {
		{
			...
			i -= size
			i = encodeVarintMsm(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x5a
	}
	if m.GasUsed != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.GasUsed))
		i--
		dAtA[i] = 0x50
	}
	if m.GasWanted != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.GasWanted))
		i--
		dAtA[i] = 0x48
	}
	if len(m.Info) > 0 {
		i -= len(m.Info)
		copy(dAtA[i:], m.Info)
		i = encodeVarintMsm(dAtA, i, uint64(len(m.Info)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Logs) > 0 {
	...
	if len(m.RawLog) > 0 {
		...
		i = encodeVarintMsm(dAtA, i, uint64(len(m.RawLog)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Data) > 0 {
		i -= len(m.Data)
		copy(dAtA[i:], m.Data)
		i = encodeVarintMsm(dAtA, i, uint64(len(m.Data)))
		i--
		dAtA[i] = 0x2a
	}
	if m.Code != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.Code))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Codespace) > 0 {
		...
		i = encodeVarintMsm(dAtA, i, uint64(len(m.Codespace)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.TxHash) > 0 {
		...
		i = encodeVarintMsm(dAtA, i, uint64(len(m.TxHash)))
		i--
		dAtA[i] = 0x12
	}
	if m.Height != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.Height))
		i--
		dAtA[i] = 0x8
	}
...
func (m *MSMMessageLog) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MSMMessageLog) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MSMMessageLog) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Log) > 0 {
		i -= len(m.Log)
		copy(dAtA[i:], m.Log)
		i = encodeVarintMsm(dAtA, i, uint64(len(m.Log)))
		i--
		dAtA[i] = 0x12
	}
	if m.MsgIndex != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.MsgIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *StringEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Type) > 0 {
		i -= len(m.Type)
		copy(dAtA[i:], m.Type)
		i = encodeVarintMsm(dAtA, i, uint64(len(m.Type)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Attribute) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintMsm(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Key) > 0 {
		i -= len(m.Key)
		copy(dAtA[i:], m.Key)
		i = encodeVarintMsm(dAtA, i, uint64(len(m.Key)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MsgData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MsgType) > 0 {
		...
		i = encodeVarintMsm(dAtA, i, uint64(len(m.MsgType)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *SearchTxsResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Limit != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.Limit))
		i--
		dAtA[i] = 0x28
	}
	if m.PageTotal != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.PageTotal))
		i--
		dAtA[i] = 0x20
	}
	if m.PageNumber != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.PageNumber))
		i--
		dAtA[i] = 0x18
	}
	if m.Count != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.Count))
		i--
		dAtA[i] = 0x10
	}
	if m.TotalCount != 0 {
		i = encodeVarintMsm(dAtA, i, uint64(m.TotalCount))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintMsm(dAtA []byte, offset int, v uint64) int {
	offset -= sovMsm(v)
	base := offset
	for v >= 1<<7 {
...
func (m *TxResponse) Size() (n int) {
	...
	_ = l
	if m.Height != 0 {
		n += 1 + sovMsm(uint64(m.Height))
	}
	l = len(m.TxHash)
	if l > 0 {
		n += 1 + l + sovMsm(uint64(l))
	}
	l = len(m.Codespace)
	if l > 0 {
		n += 1 + l + sovMsm(uint64(l))
	...
	if m.GasWanted != 0 {
		n += 1 + sovMsm(uint64(m.GasWanted))
	}
	if m.GasUsed != 0 {
		n += 1 + sovMsm(uint64(m.GasUsed))
	}
	if m.Tx != nil {
		l = m.Tx.Size()
		n += 1 + l + sovMsm(uint64(l))
...
func (m *MSMMessageLog) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SearchTxsResult) Size() (n int) {
	...
	_ = l
	if m.TotalCount != 0 {
		n += 1 + sovMsm(uint64(m.TotalCount))
	}
	if m.Count != 0 {
		n += 1 + sovMsm(uint64(m.Count))
	}
	if m.PageNumber != 0 {
		n += 1 + sovMsm(uint64(m.PageNumber))
	}
	if m.PageTotal != 0 {
		n += 1 + sovMsm(uint64(m.PageTotal))
	}
	if m.Limit != 0 {
		n += 1 + sovMsm(uint64(m.Limit))
	}
	if len(m.Txs) > 0 {
		for _, e := range m.Txs {
			l = e.Size()
...
func sovMsm(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozMsm(x uint64) (n int) {
	return sovMsm(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (this *MSMMessageLog) String() string {
	if this == nil {
		return "nil"
	}
	...
	s := strings.Join([]string{`&MSMMessageLog{`,
...
func valueToStringMsm(v interface{}) string {
...
func (m *TxResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.Logs = append(m.Logs, MSMMessageLog{})
...
func (m *MSMMessageLog) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MSMMessageLog: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MSMMessageLog: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func skipMsm(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupMsm
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthMsm        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowMsm          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupMsm = fmt.Errorf("proto: unexpected end of group")
)
