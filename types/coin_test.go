...
func (s *coinTestSuite) TestIsEqualCoin() {
	cases := []struct {
		...
		{sdk.NewInt64Coin("ucta", 1), sdk.NewInt64Coin("ucta", 10), false, false},
	}
...
func (s *coinTestSuite) TestCoinIsValid() {
	...
	cases := []struct {
		...
		{sdk.Coin{"Cta", sdk.OneInt()}, true},
		{sdk.Coin{"CTA", sdk.OneInt()}, true},
		{sdk.Coin{"a", sdk.OneInt()}, false},
		{sdk.Coin{loremIpsum, sdk.OneInt()}, false},
		{sdk.Coin{"icp/7F1D3FCF4AE79E1554D670D1AD949A9BA4E4A3C76C63093E17E446A46061A7A2", sdk.OneInt()}, true},
		{sdk.Coin{"cTa", sdk.OneInt()}, true},
...
func (s *coinTestSuite) TestCoins_Validate() {
	testCases := []struct {
		...
		{
			"ICP denominations (ADR 001)",
			sdk.Coins{
				{"icp/7F1D3FCF4AE79E1554D670D1AD949A9BA4E4A3C76C63093E17E446A46061A7A2", sdk.OneInt()},
				{"icp/876563AAAACF739EB061C67CDB5EDF2B7C9FD4AA9D876450CC21210807C2820A", sdk.NewInt(2)},
			},
			true,
		},
		{
...
func (s *coinTestSuite) TestParseCoins() {
	...
	cases := []struct {
		...
		{"", true, nil},
		{"0fcta", true, sdk.Coins{}}, // remove zero coins
		{"0fcta,1foo,99bar", true, sdk.Coins{{"bar", sdk.NewInt(99)}, {"foo", one}}}, // remove zero coins
		{"1foo", true, sdk.Coins{{"foo", one}}},
		{"10btc,1cta,20btc", false, nil},
		...
		{"10cta10", true, sdk.Coins{{"cta10", sdk.NewInt(10)}}},
		{"200transfer/channelToA/ucta", true, sdk.Coins{{"transfer/channelToA/ucta", sdk.NewInt(200)}}},
		{"50icp/7F1D3FCF4AE79E1554D670D1AD949A9BA4E4A3C76C63093E17E446A46061A7A2", true, sdk.Coins{{"icp/7F1D3FCF4AE79E1554D670D1AD949A9BA4E4A3C76C63093E17E446A46061A7A2", sdk.NewInt(50)}}},
	}
...
func (s *coinTestSuite) TestNewCoins() {
	tencta := sdk.NewInt64Coin("cta", 10)
	...
	tests := []struct {
		...
		{"one coin", []sdk.Coin{tencta}, sdk.Coins{tencta}, false},
		{"sort after create", []sdk.Coin{tenbtc, tencta}, sdk.Coins{tencta, tenbtc}, false},
		{"sort and remove zeroes", []sdk.Coin{zeroeth, tenbtc, tencta}, sdk.Coins{tencta, tenbtc}, false},
		{"panic on dups", []sdk.Coin{tencta, tencta}, sdk.Coins{}, true},
		{"panic on invalid coin", []sdk.Coin{invalidCoin, tencta}, sdk.Coins{}, true},
	}
...
func (s *coinTestSuite) TestCoinsIsAnyGT() {
	twoCta := sdk.NewInt64Coin("cta", 2)
	fiveCta := sdk.NewInt64Coin("cta", 5)
	...
	tests := []struct {
		...
		{"{} ≤ 5cta", sdk.Coins{}, sdk.Coins{fiveCta}, false},
		{"5cta > 2cta", sdk.Coins{fiveCta}, sdk.Coins{twoCta}, true},
		{"2cta ≤ 5cta", sdk.Coins{twoCta}, sdk.Coins{fiveCta}, false},
		{"2cta,6eth > 2btc,5cta,3eth", sdk.Coins{twoCta, sixEth}, sdk.Coins{twoBtc, fiveCta, threeEth}, true},
		{"2btc,2cta,3eth ≤ 5cta,6eth", sdk.Coins{twoBtc, twoCta, threeEth}, sdk.Coins{fiveCta, sixEth}, false},
		{"2cta,6eth ≤ 2btc,5cta", sdk.Coins{twoCta, sixEth}, sdk.Coins{twoBtc, fiveCta}, false},
	}
