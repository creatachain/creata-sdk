...
import msm "github.com/creatachain/augusteum/msm/types"

// InitChainer initializes application state at genesis
type InitChainer func(ctx Context, req msm.RequestInitChain) msm.ResponseInitChain
...
type BeginBlocker func(ctx Context, req msm.RequestBeginBlock) msm.ResponseBeginBlock
...
type EndBlocker func(ctx Context, req msm.RequestEndBlock) msm.ResponseEndBlock

// PeerFilter responds to p2p filtering queries from Augusteum
type PeerFilter func(info string) msm.ResponseQuery
