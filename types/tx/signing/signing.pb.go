...
// source: creata/tx/signing/v1beta1/signing.proto
...
func (SignMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fb33efc46abc5651, []int{0}
}
...
func (*SignatureDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb33efc46abc5651, []int{1}
}
...
func (*SignatureDescriptor_Data) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb33efc46abc5651, []int{1, 0}
}
...
type SignatureDescriptor_Data_Single struct {
	...
	Mode SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=creata.tx.signing.v1beta1.SignMode" json:"mode,omitempty"`
...
func (*SignatureDescriptor_Data_Single) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb33efc46abc5651, []int{1, 0, 0}
}
...
func (*SignatureDescriptor_Data_Multi) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb33efc46abc5651, []int{1, 0, 1}
}
...
func init() {
	proto.RegisterEnum("creata.tx.signing.v1beta1.SignMode", SignMode_name, SignMode_value)
	proto.RegisterType((*SignatureDescriptors)(nil), "creata.tx.signing.v1beta1.SignatureDescriptors")
	proto.RegisterType((*SignatureDescriptor)(nil), "creata.tx.signing.v1beta1.SignatureDescriptor")
	proto.RegisterType((*SignatureDescriptor_Data)(nil), "creata.tx.signing.v1beta1.SignatureDescriptor.Data")
	proto.RegisterType((*SignatureDescriptor_Data_Single)(nil), "creata.tx.signing.v1beta1.SignatureDescriptor.Data.Single")
	proto.RegisterType((*SignatureDescriptor_Data_Multi)(nil), "creata.tx.signing.v1beta1.SignatureDescriptor.Data.Multi")
}

func init() {
	proto.RegisterFile("creata/tx/signing/v1beta1/signing.proto", fileDescriptor_fb33efc46abc5651)
}

var fileDescriptor_fb33efc46abc5651 = []byte{
	// 549 bytes of a gzipped FileDescriptorProto
	,
}
