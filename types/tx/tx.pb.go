...
// source: creata/tx/v1beta1/tx.proto
...
import (
	...
	types1 "github.com/creatachain/creata-sdk/crypto/types"
	...
	signing "github.com/creatachain/creata-sdk/types/tx/signing"
...
func (*Tx) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{0}
}
...
// verification. The binary `serialize(tx: TxRaw)` is stored in Augusteum and
...
func (*TxRaw) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{1}
}
...
func (*SignDoc) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{2}
}
...
type TxBody struct {
	...
	// memotest is any arbitrary memo to be added to the transaction
	Memotest string `protobuf:"bytes,4,opt,name=memotest,proto3" json:"memotest,omitempty"`
...
func (*TxBody) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{3}
}
...
func (m *TxBody) GetMemotest() string {
	if m != nil {
		return m.Memotest
	}
	return ""
...
func (*AuthInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{4}
}
...
func (*SignerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{5}
}
...
func (*ModeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{6}
}
...
type ModeInfo_Single struct {
	...
	Mode signing.SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=creata.tx.signing.v1beta1.SignMode" json:"mode,omitempty"`
}
...
func (*ModeInfo_Single) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{6, 0}
}
...
func (*ModeInfo_Multi) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{6, 1}
}
...
type Fee struct {
	...
	Amount github_com_creatachain_creata_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/creatachain/creata-sdk/types.Coins" json:"amount"`
...
func (*Fee) Descriptor() ([]byte, []int) {
	return fileDescriptor_33f390b923947627, []int{7}
}
...
func (m *Fee) GetAmount() github_com_creatachain_creata_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func init() {
	proto.RegisterType((*Tx)(nil), "creata.tx.v1beta1.Tx")
	proto.RegisterType((*TxRaw)(nil), "creata.tx.v1beta1.TxRaw")
	proto.RegisterType((*SignDoc)(nil), "creata.tx.v1beta1.SignDoc")
	proto.RegisterType((*TxBody)(nil), "creata.tx.v1beta1.TxBody")
	proto.RegisterType((*AuthInfo)(nil), "creata.tx.v1beta1.AuthInfo")
	proto.RegisterType((*SignerInfo)(nil), "creata.tx.v1beta1.SignerInfo")
	proto.RegisterType((*ModeInfo)(nil), "creata.tx.v1beta1.ModeInfo")
	proto.RegisterType((*ModeInfo_Single)(nil), "creata.tx.v1beta1.ModeInfo.Single")
	proto.RegisterType((*ModeInfo_Multi)(nil), "creata.tx.v1beta1.ModeInfo.Multi")
	proto.RegisterType((*Fee)(nil), "creata.tx.v1beta1.Fee")
}

func init() { proto.RegisterFile("creata/tx/v1beta1/tx.proto", fileDescriptor_33f390b923947627) }

var fileDescriptor_33f390b923947627 = []byte{
	// 856 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *TxBody) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Memotest) > 0 {
		i -= len(m.Memotest)
		copy(dAtA[i:], m.Memotest)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Memotest)))
		i--
		dAtA[i] = 0x22
	}
...
func (m *TxBody) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Memotest", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Memotest = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 1023:
			if wireType != 2 {
