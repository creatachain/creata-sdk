...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/creatachain/creata-sdk/types/errors.Wrap",
		"github.com/creatachain/creata-sdk/types/errors.Wrapf",
		"github.com/creatachain/creata-sdk/types/errors.WithType",
