...
import (
	...
	"github.com/creatachain/creata-sdk/types/simulation"
)
...
func TestRandSubsetCoins(t *testing.T) {
	...
	tests := []struct {
		...
		{"seed=1", rand.New(rand.NewSource(1)), mustParseCoins("100fcta,2testtoken")},
		{"seed=50", rand.New(rand.NewSource(50)), mustParseCoins("100fcta,2testtoken")},
		{"seed=99", rand.New(rand.NewSource(99)), mustParseCoins("100fcta,2testtoken")},
	}
