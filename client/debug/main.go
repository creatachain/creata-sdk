...
// getPubKeyFromString returns a Augusteum PubKey (PubKeyEd25519) by attempting
...
$ %s debug pubkey creata1e0jnq2sun3dzjh8p2xq95kk0expwmd7shwjpfg
...
Example:
$ %s debug addr creata1e0jnq2sun3dzjh8p2xq95kk0expwmd7shwjpfg
			`, version.AppName),
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
