...
// source: creata/base/reflection/v1beta1/reflection.proto
...
func (*ListAllInterfacesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7ad4d74d6347215, []int{0}
}
...
func (*ListAllInterfacesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7ad4d74d6347215, []int{1}
}
...
func (*ListImplementationsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7ad4d74d6347215, []int{2}
}
...
func (*ListImplementationsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7ad4d74d6347215, []int{3}
}
...
func init() {
	proto.RegisterType((*ListAllInterfacesRequest)(nil), "creata.base.reflection.v1beta1.ListAllInterfacesRequest")
	proto.RegisterType((*ListAllInterfacesResponse)(nil), "creata.base.reflection.v1beta1.ListAllInterfacesResponse")
	proto.RegisterType((*ListImplementationsRequest)(nil), "creata.base.reflection.v1beta1.ListImplementationsRequest")
	proto.RegisterType((*ListImplementationsResponse)(nil), "creata.base.reflection.v1beta1.ListImplementationsResponse")
}

func init() {
	proto.RegisterFile("creata/base/reflection/v1beta1/reflection.proto", fileDescriptor_a7ad4d74d6347215)
}

var fileDescriptor_a7ad4d74d6347215 = []byte{
	// 403 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xd2, 0x4f, 0x2e, 0x4a, 0x4d,
	0x2c, 0x49, 0xd4, 0x4f, 0x4a, 0x2c, 0x4e, 0xd5, 0x2f, 0x4a, 0x4d, 0xcb, 0x49, 0x4d, 0x2e, 0xc9,
	...
	,
}
...
func (c *reflectionServiceClient) ListAllInterfaces(ctx context.Context, in *ListAllInterfacesRequest, opts ...grpc.CallOption) (*ListAllInterfacesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/creata.base.reflection.v1beta1.ReflectionService/ListAllInterfaces", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reflectionServiceClient) ListImplementations(ctx context.Context, in *ListImplementationsRequest, opts ...grpc.CallOption) (*ListImplementationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/creata.base.reflection.v1beta1.ReflectionService/ListImplementations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReflectionService_ListAllInterfaces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/creata.base.reflection.v1beta1.ReflectionService/ListAllInterfaces",
	}
...
func _ReflectionService_ListImplementations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/creata.base.reflection.v1beta1.ReflectionService/ListImplementations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ReflectionService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "creata.base.reflection.v1beta1.ReflectionService",
	...
	Metadata: "creata/base/reflection/v1beta1/reflection.proto",
}
