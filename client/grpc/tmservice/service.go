...
// NewQueryServer creates a new augusteum query server.
...
// RegisterAugusteumService registers the augusteum queries on the gRPC router.
func RegisterAugusteumService(
	qrt gogogrpc.Server,
	clientCtx client.Context,
	interfaceRegistry codectypes.InterfaceRegistry,
) {
...
// RegisterGRPCGatewayRoutes mounts the augusteum service's GRPC-gateway routes on the
// given Mux.
