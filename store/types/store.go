...
import (
	...
	tmstrings "github.com/creatachain/augusteum/libs/strings"
...
// Queryable allows a Store to expose internal state to the msm.Query
// interface. Multistore can route requests to the proper Store.
//
// This is an optional, but useful extension to any CommitStore
type Queryable interface {
	Query(msm.RequestQuery) msm.ResponseQuery
}
...
// CapabilityKey represent the Creata SDK keys for object-capability
