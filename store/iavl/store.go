...
import (
	...
	tmcrypto "github.com/creatachain/augusteum/proto/augusteum/crypto"
	"github.com/creatachain/iavl"
	dbm "github.com/creatachain/tm-db"

	"github.com/creatachain/creata-sdk/store/cachekv"
...
func getHeight(tree Tree, req msm.RequestQuery) int64 {
	height := req.Height
	if height == 0 {
		latest := tree.Version()
...
// Query implements MSM interface, allows queries
//
...
func (st *Store) Query(req msm.RequestQuery) (res msm.ResponseQuery) {
