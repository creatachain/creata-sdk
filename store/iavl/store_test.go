...
func TestGetImmutable(t *testing.T) {
	...
	res := newStore.Query(msm.RequestQuery{Data: []byte("hello"), Height: cID.Version, Path: "/key", Prove: true})
...
func TestIAVLStoreQuery(t *testing.T) {
	...
	ver := cid.Version
	query := msm.RequestQuery{Path: "/key", Data: k1, Height: ver}
	querySub := msm.RequestQuery{Path: "/subspace", Data: ksub, Height: ver}
	...
	query2 := msm.RequestQuery{Path: "/key", Data: k2, Height: cid.Version}
	...
	query0 := msm.RequestQuery{Path: "/key", Data: k1}
