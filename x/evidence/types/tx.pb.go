...
// source: creata/evidence/v1beta1/tx.proto
...
func (*MsgSubmitEvidence) Descriptor() ([]byte, []int) {
	return fileDescriptor_27fdb9c1b831181d, []int{0}
}
...
func (*MsgSubmitEvidenceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_27fdb9c1b831181d, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgSubmitEvidence)(nil), "creata.evidence.v1beta1.MsgSubmitEvidence")
	proto.RegisterType((*MsgSubmitEvidenceResponse)(nil), "creata.evidence.v1beta1.MsgSubmitEvidenceResponse")
}

func init() { proto.RegisterFile("creata/evidence/v1beta1/tx.proto", fileDescriptor_27fdb9c1b831181d) }

var fileDescriptor_27fdb9c1b831181d = []byte{
	// 321 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x48, 0x2e, 0x4a, 0x4d,
	0x2c, 0x49, 0xd4, 0x4f, 0x2d, 0xcb, 0x4c, 0x49, 0xcd, 0x4b, 0x4e, 0xd5, 0x2f, 0x33, 0x4c, 0x4a,
	...
	0x08, 0x2c, 0x3d, 0x0c, 0x0b, 0xa4, 0x8c, 0x88, 0x57, 0x0b, 0x73, 0x8c, 0x53, 0xc0, 0x8a, 0x47,
	...
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0x0b, 0x0d, 0xdd, 0xe4, 0x8c, 0xc4, 0xcc, 0x3c, 0x28,
	0x5b, 0xb7, 0x38, 0x25, 0x5b, 0xbf, 0x02, 0x11, 0xd1, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c,
	0xe0, 0xb0, 0x32, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xfc, 0x49, 0xb9, 0x56, 0x08, 0x02, 0x00,
	0x00,
}
...
func (c *msgClient) SubmitEvidence(ctx context.Context, in *MsgSubmitEvidence, opts ...grpc.CallOption) (*MsgSubmitEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/creata.evidence.v1beta1.Msg/SubmitEvidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitEvidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/creata.evidence.v1beta1.Msg/SubmitEvidence",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "creata.evidence.v1beta1.Msg",
	...
	Metadata: "creata/evidence/v1beta1/tx.proto",
}
