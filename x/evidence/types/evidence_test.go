...
func TestEquivocation_Valid(t *testing.T) {
	...
	require.Equal(t, e.String(), "height: 100\ntime: 2006-01-02T15:04:05Z\npower: 1000000\nconsensus_address: creatavalcons1vehk7h6lta047h6lta047h6lta047h6l8m4r53\n")
...
func TestEvidenceAddressConversion(t *testing.T) {
	...
	evidence := types.FromMSMEvidence(tmEvidence).(*types.Equivocation)
