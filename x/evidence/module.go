...
import (
	...
	eviclient "github.com/creatachain/creata-sdk/x/evidence/client"
	"github.com/creatachain/creata-sdk/x/evidence/client/cli"
	"github.com/creatachain/creata-sdk/x/evidence/client/rest"
...
// BeginBlock executes all MSM BeginBlock logic respective to the evidence module.
func (am AppModule) BeginBlock(ctx sdk.Context, req msm.RequestBeginBlock) {
	BeginBlocker(ctx, req, am.keeper)
}

// EndBlock executes all MSM EndBlock logic respective to the evidence module. It
