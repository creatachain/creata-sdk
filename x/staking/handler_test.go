...
func bootstrapHandlerGenesisTest(t *testing.T, power int64, numAddrs int, accAmount sdk.Int) (*creataapp.CreataApp, sdk.Context, []sdk.AccAddress, []sdk.ValAddress) {
...
func TestInvalidPubKeyTypeMsgCreateValidator(t *testing.T) {
	...
	ctx = ctx.WithConsensusParams(&msm.ConsensusParams{
		Validator: &tmproto.ValidatorParams{PubKeyTypes: []string{tmtypes.MSMPubKeyTypeEd25519}},
	})
...
func TestBothPubKeyTypesMsgCreateValidator(t *testing.T) {
	...
	ctx = ctx.WithConsensusParams(&msm.ConsensusParams{
		Validator: &tmproto.ValidatorParams{PubKeyTypes: []string{tmtypes.MSMPubKeyTypeEd25519, tmtypes.MSMPubKeyTypeSecp256k1}},
	})
