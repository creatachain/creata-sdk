...
func TestDelegation(t *testing.T) {
	...
	addrDels := creataapp.AddTestAddrsIncremental(app, ctx, 3, sdk.NewInt(10000))
	valAddrs := creataapp.ConvertAddrsToValAddrs(addrDels)
...
func TestUnbondingDelegation(t *testing.T) {
	...
	delAddrs := creataapp.AddTestAddrsIncremental(app, ctx, 2, sdk.NewInt(10000))
	valAddrs := creataapp.ConvertAddrsToValAddrs(delAddrs)
...
func TestUnbondDelegation(t *testing.T) {
	...
	delAddrs := creataapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(10000))
	valAddrs := creataapp.ConvertAddrsToValAddrs(delAddrs)
...
func TestUnbondingDelegationsMaxEntries(t *testing.T) {
	...
	addrDels := creataapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(10000))
...
func TestUndelegateFromUnbondingValidator(t *testing.T) {
	...
	addrDels := creataapp.AddTestAddrsIncremental(app, ctx, 2, sdk.NewInt(0))
	addrVals := creataapp.ConvertAddrsToValAddrs(addrDels)
...
func TestRedelegateToSameValidator(t *testing.T) {
	...
	addrDels := creataapp.AddTestAddrsIncremental(app, ctx, 1, sdk.NewInt(0))
	addrVals := creataapp.ConvertAddrsToValAddrs(addrDels)
