...
func bootstrapSlashTest(t *testing.T, power int64) (*creataapp.CreataApp, sdk.Context, []sdk.AccAddress, []sdk.ValAddress) {
...
func TestSlashUnbondingDelegation(t *testing.T) {
	...
	// test valid slash, before expiration timestamp and to which ucta contributed
	notBondedPool := app.StakingKeeper.GetNotBondedPool(ctx)
...
func TestSlashRedelegation(t *testing.T) {
	...
	// started redelegating prior to the current height, ucta didn't contribute to infraction
...
func TestSlashWithUnbondingDelegation(t *testing.T) {
	...
	// power decreased by 3 - 6 ucta originally bonded at the time of infraction
	// was still bonded at the time of discovery and was slashed by half, 4 ucta
	...
	// slash validator again
	// all originally bonded ucta has been slashed, so this will have no effect
	// on the unbonding delegation, but it will slash ucta bonded since the infraction
	ctx = ctx.WithBlockHeight(13)
	app.StakingKeeper.Slash(ctx, consAddr, 9, 10, fraction)
	...
	// read updated validator
	// power decreased by 1 again, validator is out of ucta
...
func TestSlashWithRedelegation(t *testing.T) {
	...
	validator, found = app.StakingKeeper.GetValidatorByConsAddr(ctx, consAddr)
	require.True(t, found)
	// power decreased by 2 - 4 ucta originally bonded at the time of infraction
	// was still bonded at the time of discovery and was slashed by half, 4 ucta
	// bonded at the time of discovery hadn't been bonded at the time of infraction
	// and wasn't slashed
...
func TestSlashBoth(t *testing.T) {
	...
	validator, found = app.StakingKeeper.GetValidatorByConsAddr(ctx, sdk.GetConsAddress(PKs[0]))
	require.True(t, found)
	// power not decreased, all ucta was bonded since
