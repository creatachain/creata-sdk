...
func TestNewQuerier(t *testing.T) {
	...
	addrs := creataapp.AddTestAddrs(app, ctx, 500, sdk.NewInt(10000))
...
func TestQueryParametersPool(t *testing.T) {
	...
	res, err := querier(ctx, []string{types.QueryParameters}, msm.RequestQuery{})
	require.NoError(t, err)
	...
	res, err = querier(ctx, []string{types.QueryPool}, msm.RequestQuery{})
	require.NoError(t, err)
...
func TestQueryValidators(t *testing.T) {
	...
	addrs := creataapp.AddTestAddrs(app, ctx, 500, sdk.TokensFromConsensusPower(10000))
...
func TestQueryDelegation(t *testing.T) {
	...
	addrs := creataapp.AddTestAddrs(app, ctx, 2, sdk.TokensFromConsensusPower(10000))
	addrAcc1, addrAcc2 := addrs[0], addrs[1]
	addrVal1, addrVal2 := sdk.ValAddress(addrAcc1), sdk.ValAddress(addrAcc2)

	pubKeys := creataapp.CreateTestPubKeys(2)
...
func TestQueryValidatorDelegations_Pagination(t *testing.T) {
	...
	addrs := creataapp.AddTestAddrs(app, ctx, 100, sdk.TokensFromConsensusPower(10000))
	pubKeys := creataapp.CreateTestPubKeys(1)
