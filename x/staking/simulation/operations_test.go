...
import (
	...
	"github.com/creatachain/creata-sdk/x/staking/simulation"
...
func TestWeightedOperations(t *testing.T) {
	...
	expected := []struct {
		...
		opMsgRoute string
		opMsgName  string
	}{{creataappparams.DefaultWeightMsgCreateValidator, types.ModuleName, types.TypeMsgCreateValidator},
		{creataappparams.DefaultWeightMsgEditValidator, types.ModuleName, types.TypeMsgEditValidator},
		{creataappparams.DefaultWeightMsgDelegate, types.ModuleName, types.TypeMsgDelegate},
		{creataappparams.DefaultWeightMsgUndelegate, types.ModuleName, types.TypeMsgUndelegate},
		{creataappparams.DefaultWeightMsgBeginRedelegate, types.ModuleName, types.TypeMsgBeginRedelegate},
	}
...
func TestSimulateMsgCreateValidator(t *testing.T) {
	...
	// begin a new block
	app.BeginBlock(msm.RequestBeginBlock{Header: tmproto.Header{Height: app.LastBlockHeight() + 1, AppHash: app.LastCommitID().Hash}})
	...
	require.Equal(t, "creata1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.DelegatorAddress)
	require.Equal(t, "creatavaloper1ghekyjucln7y67ntx7cf27m9dpuxxemnsvnaes", msg.ValidatorAddress)
...
func TestSimulateMsgEditValidator(t *testing.T) {
	...
	// begin a new block
	app.BeginBlock(msm.RequestBeginBlock{Header: tmproto.Header{Height: app.LastBlockHeight() + 1, AppHash: app.LastCommitID().Hash, Time: blockTime}})
	...
	require.Equal(t, "creatavaloper1tnh2q55v8wyygtt9srz5safamzdengsn9dsd7z", msg.ValidatorAddress)
	require.Len(t, futureOperations, 0)
}
...
func TestSimulateMsgDelegate(t *testing.T) {
	...
	require.Equal(t, "ucta", msg.Amount.Denom)
...
func TestSimulateMsgUndelegate(t *testing.T) {
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, "creata1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.DelegatorAddress)
...
func TestSimulateMsgBeginRedelegate(t *testing.T) {
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, "creata12gwd9jchc69wck8dhstxgwz3z8qs8yv67ps8mu", msg.DelegatorAddress)
	require.Equal(t, "489348507626016866", msg.Amount.Amount.String())
	require.Equal(t, "ucta", msg.Amount.Denom)
	require.Equal(t, types.TypeMsgBeginRedelegate, msg.Type())
	require.Equal(t, "creatavaloper1h6a7shta7jyc72hyznkys683z98z36e0zdk8g9", msg.ValidatorDstAddress)
	require.Equal(t, "creatavaloper17s94pzwhsn4ah25tec27w70n65h5t2scgxzkv2", msg.ValidatorSrcAddress)
	require.Len(t, futureOperations, 0)
...
func getTestingAccounts(t *testing.T, r *rand.Rand, app *creataapp.CreataApp, ctx sdk.Context, n int) []simtypes.Account {
...
func getTestingValidator0(t *testing.T, app *creataapp.CreataApp, ctx sdk.Context, accounts []simtypes.Account) types.Validator {
...
func getTestingValidator1(t *testing.T, app *creataapp.CreataApp, ctx sdk.Context, accounts []simtypes.Account) types.Validator {
...
func getTestingValidator(t *testing.T, app *creataapp.CreataApp, ctx sdk.Context, accounts []simtypes.Account, commission types.Commission, n int) types.Validator {
	account := accounts[n]
...
func setupValidatorRewards(app *creataapp.CreataApp, ctx sdk.Context, valAddress sdk.ValAddress) {
