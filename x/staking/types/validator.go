...
// Copied from augusteum/types/validator_set.go
...
// MSMValidatorUpdate returns an msm.ValidatorUpdate from a staking validator type
// with the full validator power
func (v Validator) MSMValidatorUpdate() msm.ValidatorUpdate {
...
// MSMValidatorUpdateZero returns an msm.ValidatorUpdate from a staking validator type
// with zero power used for validator updates.
func (v Validator) MSMValidatorUpdateZero() msm.ValidatorUpdate {
	tmProtoPk, err := v.TmConsPublicKey()
	if err != nil {
		panic(err)
	}
