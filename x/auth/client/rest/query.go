...
import (
	...
	clientrest "github.com/creatachain/creata-sdk/client/rest"
	...
	genutilrest "github.com/creatachain/creata-sdk/x/genutil/client/rest"
)
...
func QueryTxsRequestHandlerFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = checkAminoMarshalError(clientCtx, searchResult, "/creatachain/tx/v1beta1/txs")
		if err != nil {
			rest.WriteErrorResponse(w, http.StatusInternalServerError, err.Error())
...
func QueryTxRequestHandlerFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = checkAminoMarshalError(clientCtx, output, "/creatachain/tx/v1beta1/txs/{txhash}")
		if err != nil {
			rest.WriteErrorResponse(w, http.StatusInternalServerError, err.Error())
...
func packStdTxResponse(w http.ResponseWriter, clientCtx client.Context, txRes *sdk.TxResponse) error {
	// We just unmarshalled from Augusteum, we take the proto Tx's raw
