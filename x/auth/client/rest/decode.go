...
func DecodeTxRequestHandlerFn(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = checkAminoMarshalError(clientCtx, response, "/creatachain/tx/v1beta1/txs/decode")
		if err != nil {
...
// convertToStdTx converts tx proto binary bytes retrieved from Augusteum into
