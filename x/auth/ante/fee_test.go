...
func (suite *AnteTestSuite) TestEnsureMempoolFees() {
	...
	ctaPrice := sdk.NewDecCoinFromDec("cta", sdk.NewDec(200).Quo(sdk.NewDec(100000)))
	highGasPrice := []sdk.DecCoin{ctaPrice}
	...
	ctaPrice = sdk.NewDecCoinFromDec("cta", sdk.NewDec(0).Quo(sdk.NewDec(100000)))
	lowGasPrice := []sdk.DecCoin{ctaPrice}
...
func (suite *AnteTestSuite) TestDeductFees() {
	...
	suite.app.BankKeeper.SetBalances(suite.ctx, addr1, sdk.NewCoins(sdk.NewCoin("cta", sdk.NewInt(10))))
	...
	suite.app.AccountKeeper.SetAccount(suite.ctx, acc)
	suite.app.BankKeeper.SetBalances(suite.ctx, addr1, sdk.NewCoins(sdk.NewCoin("cta", sdk.NewInt(200))))
