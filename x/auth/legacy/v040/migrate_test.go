...
import (
	...
	v034 "github.com/creatachain/creata-sdk/x/auth/legacy/v034"
...
func TestMigrate(t *testing.T) {
  ...
  "accounts": [
    {
      "@type": "/creata.auth.v1beta1.BaseAccount",
      "account_number": "1",
      "address": "creata13syh7de9xndv9wmklccpfvc0d8dcyvay4s6z6l",
      "pub_key": {
        "@type": "/creata.crypto.secp256k1.PubKey",
        "key": "A8oWyJkohwy8XZ0Df92jFMBTtTPMvYJplYIrlEHTKPYk"
      },
      "sequence": "0"
    },
    {
      "@type": "/creata.auth.v1beta1.ModuleAccount",
      "base_account": {
        "account_number": "1",
        "address": "creata1v57fx2l2rt6ehujuu99u2fw05779m5e2ux4z2h",
        "pub_key": {
          "@type": "/creata.crypto.secp256k1.PubKey",
    ...
    {
      "@type": "/creata.vesting.v1beta1.BaseVestingAccount",
      "base_account": {
        "account_number": "1",
        "address": "creata18hnp9fjflrkeeqn4gmhjhzljusxzmjeartdckw",
        "pub_key": {
          "@type": "/creata.crypto.secp256k1.PubKey",
    ...
    {
      "@type": "/creata.vesting.v1beta1.ContinuousVestingAccount",
      "base_vesting_account": {
        "base_account": {
          "account_number": "1",
          "address": "creata1t9kvvejvk6hjtddx6antck39s206csqduq3ke3",
          "pub_key": {
            "@type": "/creata.crypto.secp256k1.PubKey",
    ...
    {
      "@type": "/creata.vesting.v1beta1.PeriodicVestingAccount",
      "base_vesting_account": {
        "base_account": {
          "account_number": "1",
          "address": "creata1s4ss9zquz7skvguechzlk3na635jdrecl0sgy2",
          "pub_key": {
            "@type": "/creata.crypto.secp256k1.PubKey",
    ...
    {
      "@type": "/creata.vesting.v1beta1.DelayedVestingAccount",
      "base_vesting_account": {
        "base_account": {
          "account_number": "1",
          "address": "creata1mcc6rwrj4hswf8p9ct82c7lmf77w9tuk07rha4",
          "pub_key": {
            "@type": "/creata.crypto.secp256k1.PubKey",
    ...
    },
    {
      "@type": "/creata.auth.v1beta1.BaseAccount",
      "account_number": "1",
      "address": "creata16ydaqh0fcnh4qt7a3jme4mmztm2qel5axcpw00",
      "pub_key": null,
      "sequence": "0"
    }
  ],
