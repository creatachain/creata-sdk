...
// source: creata/auth/v1beta1/auth.proto
...
func (*BaseAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_b072f78a759feb81, []int{0}
}
...
func (*ModuleAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_b072f78a759feb81, []int{1}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_b072f78a759feb81, []int{2}
}
...
func init() {
	proto.RegisterType((*BaseAccount)(nil), "creata.auth.v1beta1.BaseAccount")
	proto.RegisterType((*ModuleAccount)(nil), "creata.auth.v1beta1.ModuleAccount")
	proto.RegisterType((*Params)(nil), "creata.auth.v1beta1.Params")
}

func init() { proto.RegisterFile("creata/auth/v1beta1/auth.proto", fileDescriptor_b072f78a759feb81) }

var fileDescriptor_b072f78a759feb81 = []byte{
	// 676 bytes of a gzipped FileDescriptorProto
	,
}
