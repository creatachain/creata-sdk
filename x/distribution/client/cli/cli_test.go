...
import (
	...
	testnet "github.com/creatachain/creata-sdk/testutil/network"
	sdk "github.com/creatachain/creata-sdk/types"
	"github.com/creatachain/creata-sdk/x/distribution/client/cli"
	distrtestutil "github.com/creatachain/creata-sdk/x/distribution/client/testutil"
...
func (s *IntegrationTestSuite) TestGetCmdQueryValidatorOutstandingRewards() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			`{"rewards":[{"denom":"ucta","amount":"232.260000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryValidatorCommission() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			`{"commission":[{"denom":"ucta","amount":"116.130000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryDelegatorRewards() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			fmt.Sprintf(`{"rewards":[{"validator_address":"%s","reward":[{"denom":"ucta","amount":"387.100000000000000000"}]}],"total":[{"denom":"ucta","amount":"387.100000000000000000"}]}`, valAddr.String()),
		},
		{
			...
			false,
			`{"rewards":[{"denom":"ucta","amount":"387.100000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryCommunityPool() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			`{"pool":[{"denom":"ucta","amount":"4.740000000000000000"}]}`,
		},
		{
			"text output",
