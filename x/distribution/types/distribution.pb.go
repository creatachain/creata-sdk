...
// source: creata/distribution/v1beta1/distribution.proto
...
type Params struct {
	CommunityTax        github_com_creatachain_creata_sdk_types.Dec `protobuf:"bytes,1,opt,name=community_tax,json=communityTax,proto3,customtype=github.com/creatachain/creata-sdk/types.Dec" json:"community_tax" yaml:"community_tax"`
	BaseProposerReward  github_com_creatachain_creata_sdk_types.Dec `protobuf:"bytes,2,opt,name=base_proposer_reward,json=baseProposerReward,proto3,customtype=github.com/creatachain/creata-sdk/types.Dec" json:"base_proposer_reward" yaml:"base_proposer_reward"`
	BonusProposerReward github_com_creatachain_creata_sdk_types.Dec `protobuf:"bytes,3,opt,name=bonus_proposer_reward,json=bonusProposerReward,proto3,customtype=github.com/creatachain/creata-sdk/types.Dec" json:"bonus_proposer_reward" yaml:"bonus_proposer_reward"`
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{0}
}
...
type ValidatorHistoricalRewards struct {
	CumulativeRewardRatio github_com_creatachain_creata_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=cumulative_reward_ratio,json=cumulativeRewardRatio,proto3,castrepeated=github.com/creatachain/creata-sdk/types.DecCoins" json:"cumulative_reward_ratio" yaml:"cumulative_reward_ratio"`
...
func (*ValidatorHistoricalRewards) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{1}
}
...
func (m *ValidatorHistoricalRewards) GetCumulativeRewardRatio() github_com_creatachain_creata_sdk_types.DecCoins {
	if m != nil {
...
func (*ValidatorCurrentRewards) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{2}
}
...
func (m *ValidatorCurrentRewards) GetRewards() github_com_creatachain_creata_sdk_types.DecCoins {
	if m != nil {
		return m.Rewards
	}
	return nil
...
type ValidatorAccumulatedCommission struct {
	Commission github_com_creatachain_creata_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=commission,proto3,castrepeated=github.com/creatachain/creata-sdk/types.DecCoins" json:"commission"`
}
...
func (*ValidatorAccumulatedCommission) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{3}
}
...
func (m *ValidatorAccumulatedCommission) GetCommission() github_com_creatachain_creata_sdk_types.DecCoins {
	if m != nil {
		return m.Commission
	}
	return nil
...
type ValidatorOutstandingRewards struct {
	Rewards github_com_creatachain_creata_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=rewards,proto3,castrepeated=github.com/creatachain/creata-sdk/types.DecCoins" json:"rewards" yaml:"rewards"`
}
...
func (*ValidatorOutstandingRewards) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{4}
}
...
func (m *ValidatorOutstandingRewards) GetRewards() github_com_creatachain_creata_sdk_types.DecCoins {
	if m != nil {
		return m.Rewards
	}
	return nil
...
type ValidatorSlashEvent struct {
	...
	Fraction        github_com_creatachain_creata_sdk_types.Dec `protobuf:"bytes,2,opt,name=fraction,proto3,customtype=github.com/creatachain/creata-sdk/types.Dec" json:"fraction"`
}
...
func (*ValidatorSlashEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{5}
}
...
func (*ValidatorSlashEvents) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{6}
}
...
type FeePool struct {
	CommunityPool github_com_creatachain_creata_sdk_types.DecCoins `protobuf:"bytes,1,rep,name=community_pool,json=communityPool,proto3,castrepeated=github.com/creatachain/creata-sdk/types.DecCoins" json:"community_pool" yaml:"community_pool"`
}
...
func (*FeePool) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{7}
}
...
func (m *FeePool) GetCommunityPool() github_com_creatachain_creata_sdk_types.DecCoins {
	if m != nil {
...
type CommunityPoolSpendProposal struct {
	...
	Amount      github_com_creatachain_creata_sdk_types.Coins `protobuf:"bytes,4,rep,name=amount,proto3,castrepeated=github.com/creatachain/creata-sdk/types.Coins" json:"amount"`
}
...
func (*CommunityPoolSpendProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{8}
}
...
type DelegatorStartingInfo struct {
	...
	Ucta           github_com_creatachain_creata_sdk_types.Dec `protobuf:"bytes,2,opt,name=ucta,proto3,customtype=github.com/creatachain/creata-sdk/types.Dec" json:"ucta" yaml:"ucta"`
...
func (*DelegatorStartingInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{9}
}
...
type DelegationDelegatorReward struct {
	...
	Reward           github_com_creatachain_creata_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=reward,proto3,castrepeated=github.com/creatachain/creata-sdk/types.DecCoins" json:"reward"`
}
...
func (*DelegationDelegatorReward) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{10}
}
...
func (*CommunityPoolSpendProposalWithDeposit) Descriptor() ([]byte, []int) {
	return fileDescriptor_174cea8b5c9b2ce7, []int{11}
}
...
func init() {
	proto.RegisterType((*Params)(nil), "creata.distribution.v1beta1.Params")
	proto.RegisterType((*ValidatorHistoricalRewards)(nil), "creata.distribution.v1beta1.ValidatorHistoricalRewards")
	proto.RegisterType((*ValidatorCurrentRewards)(nil), "creata.distribution.v1beta1.ValidatorCurrentRewards")
	proto.RegisterType((*ValidatorAccumulatedCommission)(nil), "creata.distribution.v1beta1.ValidatorAccumulatedCommission")
	proto.RegisterType((*ValidatorOutstandingRewards)(nil), "creata.distribution.v1beta1.ValidatorOutstandingRewards")
	proto.RegisterType((*ValidatorSlashEvent)(nil), "creata.distribution.v1beta1.ValidatorSlashEvent")
	proto.RegisterType((*ValidatorSlashEvents)(nil), "creata.distribution.v1beta1.ValidatorSlashEvents")
	proto.RegisterType((*FeePool)(nil), "creata.distribution.v1beta1.FeePool")
	proto.RegisterType((*CommunityPoolSpendProposal)(nil), "creata.distribution.v1beta1.CommunityPoolSpendProposal")
	proto.RegisterType((*DelegatorStartingInfo)(nil), "creata.distribution.v1beta1.DelegatorStartingInfo")
	proto.RegisterType((*DelegationDelegatorReward)(nil), "creata.distribution.v1beta1.DelegationDelegatorReward")
	proto.RegisterType((*CommunityPoolSpendProposalWithDeposit)(nil), "creata.distribution.v1beta1.CommunityPoolSpendProposalWithDeposit")
}

func init() {
	proto.RegisterFile("creata/distribution/v1beta1/distribution.proto", fileDescriptor_174cea8b5c9b2ce7)
}

var fileDescriptor_174cea8b5c9b2ce7 = []byte{
	...
	,
}
...
func (m *DelegatorStartingInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	}
	{
		size := m.Ucta.Size()
		i -= size
		if _, err := m.Ucta.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintDistribution(dAtA, i, uint64(size))
	}
...
func (m *DelegatorStartingInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ucta", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Ucta.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
