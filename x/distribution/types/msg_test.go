...
func TestMsgDepositIntoCommunityPool(t *testing.T) {
	tests := []struct {
		...
		{sdk.NewCoins(sdk.NewInt64Coin("ucta", 10000)), sdk.AccAddress{}, false},
		{sdk.Coins{sdk.NewInt64Coin("ucta", 10), sdk.NewInt64Coin("ucta", 10)}, delAddr1, false},
		{sdk.NewCoins(sdk.NewInt64Coin("ucta", 1000)), delAddr1, true},
	}
	for i, tc := range tests {
