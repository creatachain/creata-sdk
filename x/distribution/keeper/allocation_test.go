...
func TestAllocateTokensToValidatorWithCommission(t *testing.T) {
	...
	addrs := creataapp.AddTestAddrs(app, ctx, 3, sdk.NewInt(1234))
...
func TestAllocateTokensToManyValidators(t *testing.T) {
	...
	addrs := creataapp.AddTestAddrs(app, ctx, 2, sdk.NewInt(1234))
	valAddrs := creataapp.ConvertAddrsToValAddrs(addrs)
	tstaking := teststaking.NewHelper(t, ctx, app.StakingKeeper)
	...
	msmValA := msm.Validator{
		Address: valConsPk1.Address(),
		Power:   100,
	}
	msmValB := msm.Validator{
