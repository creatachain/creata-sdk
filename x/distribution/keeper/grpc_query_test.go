...
func (suite *KeeperTestSuite) SetupTest() {
	...
	suite.addrs = creataapp.AddTestAddrs(app, ctx, 2, sdk.NewInt(1000000000))
	suite.valAddrs = creataapp.ConvertAddrsToValAddrs(suite.addrs)
}
...
func (suite *KeeperTestSuite) TestGRPCValidatorOutstandingRewards() {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("ucta", sdk.NewDec(300)),
	}
		...
		},
		{
			...
			func() {
				...
				expectedDelReward := types.NewDelegationDelegatorReward(valAddrs[0],
					sdk.DecCoins{sdk.NewInt64DecCoin("ucta", 5)})
