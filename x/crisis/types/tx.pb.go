...
// source: creata/crisis/v1beta1/tx.proto
...
func (*MsgVerifyInvariant) Descriptor() ([]byte, []int) {
	return fileDescriptor_868268efa2f49332, []int{0}
}
...
func (*MsgVerifyInvariantResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_868268efa2f49332, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgVerifyInvariant)(nil), "creata.crisis.v1beta1.MsgVerifyInvariant")
	proto.RegisterType((*MsgVerifyInvariantResponse)(nil), "creata.crisis.v1beta1.MsgVerifyInvariantResponse")
}

func init() { proto.RegisterFile("creata/crisis/v1beta1/tx.proto", fileDescriptor_868268efa2f49332) }

var fileDescriptor_868268efa2f49332 = []byte{
	// 323 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x4b, 0x2e, 0x4a, 0x4d,
	0x2c, 0x49, 0xd4, 0x4f, 0x2e, 0xca, 0x2c, 0xce, 0x2c, 0xd6, 0x2f, 0x33, 0x4c, 0x4a, 0x2d, 0x49,
	...
	0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x43, 0x8c, 0x4d, 0xce, 0x48, 0xcc, 0xcc,
	0x83, 0xb2, 0x75, 0x8b, 0x53, 0xb2, 0xf5, 0x2b, 0x60, 0xb1, 0x5d, 0x52, 0x59, 0x90, 0x5a, 0x9c,
	0xc4, 0x06, 0x8e, 0x3c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x11, 0x31, 0x90, 0x41, 0x0b,
	0x02, 0x00, 0x00,
}
...
func (c *msgClient) VerifyInvariant(ctx context.Context, in *MsgVerifyInvariant, opts ...grpc.CallOption) (*MsgVerifyInvariantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/creata.crisis.v1beta1.Msg/VerifyInvariant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_VerifyInvariant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/creata.crisis.v1beta1.Msg/VerifyInvariant",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "creata.crisis.v1beta1.Msg",
	...
	Metadata: "creata/crisis/v1beta1/tx.proto",
}
