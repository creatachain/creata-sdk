...
import (
	...
	msm_server "github.com/creatachain/augusteum/msm/server"
	...
	"github.com/creatachain/creata-sdk/server/mock"
...
func TestStartStandAlone(t *testing.T) {
	...
	svr, err := msm_server.NewServer(svrAddr, "socket", app)
	require.NoError(t, err, "error creating listener")

	svr.SetLogger(logger.With("module", "msm-server"))
	err = svr.Start()
	require.NoError(t, err)
