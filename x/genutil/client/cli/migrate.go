...
import (
	...
	v036 "github.com/creatachain/creata-sdk/x/genutil/legacy/v036"
	v038 "github.com/creatachain/creata-sdk/x/genutil/legacy/v038"
	v039 "github.com/creatachain/creata-sdk/x/genutil/legacy/v039"
	v040 "github.com/creatachain/creata-sdk/x/genutil/legacy/v040"
...
Example:
$ %s migrate v0.36 /path/to/genesis.json --chain-id=creatahub-3 --genesis-time=2019-04-22T17:00:00Z
`, version.AppName),
