...
const chainUpgradeGuide = "https://docs.creata.network/master/migrations/chain-upgrade-guide-040.html"
...
// Augusteum GenesisDoc. This function does not do any creata-related
// validation.
func validateGenDoc(importGenesisFile string) (*tmtypes.GenesisDoc, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("%s. Make sure that"+
			" you have correctly migrated all Augusteum consensus params, please see the"+
