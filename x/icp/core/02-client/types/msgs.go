...
// message types for the ICP client
const (
...
// for amino transaction verification which ICP does not support.
func (msg MsgCreateClient) GetSignBytes() []byte {
	panic("ICP messages do not support amino")
}
...
func (msg MsgUpdateClient) ValidateBasic() error {
	...
	if msg.ClientId == exported.Localhost {
		return sdkerrors.Wrap(ErrInvalidClient, "localhost client is only updated on MSM BeginBlock")
	}
