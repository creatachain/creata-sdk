...
var (
	// DefaultAllowedClients are "06-solomachine" and "07-augusteum"
	DefaultAllowedClients = []string{exported.Solomachine, exported.Augusteum}
...
// NewParams creates a new parameter configuration for the icp transfer module
...
// DefaultParams is the default parameter configuration for the icp-transfer module
func DefaultParams() Params {
	return NewParams(DefaultAllowedClients...)
}

// Validate all icp-transfer module parameters
