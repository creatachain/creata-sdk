...
var sdkSpecs = []*ics23.ProofSpec{ics23.IavlSpec, ics23.AugusteumSpec}
...
// Applied on SDK-based ICP implementation
...
// This represents the path in the same way the augusteum KeyPath will
