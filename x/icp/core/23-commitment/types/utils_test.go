...
import (
	...
	crypto "github.com/creatachain/augusteum/proto/augusteum/crypto"
	"github.com/stretchr/testify/require"

	"github.com/creatachain/creata-sdk/x/icp/core/23-commitment/types"
)
...
func (suite *MerkleTestSuite) TestConvertProofs() {
	...
	testcases := []struct {
	...
	}{
		{
			...
			func() {
				res := suite.store.Query(msm.RequestQuery{
