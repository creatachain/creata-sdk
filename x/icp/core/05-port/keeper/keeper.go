...
import (
	...
	"github.com/creatachain/creata-sdk/x/icp/core/05-port/types"
	host "github.com/creatachain/creata-sdk/x/icp/core/24-host"
)

// Keeper defines the ICP connection keeper
type Keeper struct {
	scopedKeeper capabilitykeeper.ScopedKeeper
}

// NewKeeper creates a new ICP connection Keeper instance
...
// it as an extra parameter when calling functions on the ICP module.
...
// LookupModuleByPort will return the ICPModule along with the capability associated with a given portID
