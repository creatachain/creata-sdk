...
const (
	// ModuleName is the name of the ICP module
	ModuleName = "icp"

	// StoreKey is the string store representation
	StoreKey string = ModuleName

	// QuerierRoute is the querier route for the ICP module
	QuerierRoute string = ModuleName

	// RouterKey is the msg router key for the ICP module
	RouterKey string = ModuleName
)

// KVStore key prefixes for ICP
var (
