...
import (
	...
	connectionutils "github.com/creatachain/creata-sdk/x/icp/core/03-connection/client/utils"
...
func NewChannelOpenInitCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			version, _ := cmd.Flags().GetString(FlagICPVersion)
	...
	cmd.Flags().String(FlagICPVersion, icptransfertypes.Version, "ICP application version")
