...
const (
	// SubModuleName defines the ICP channels name
	SubModuleName = "channel"

	// StoreKey is the store key string for ICP channels
	StoreKey = SubModuleName

	// RouterKey is the message route for ICP channels
	RouterKey = SubModuleName

	// QuerierRoute is the querier route for ICP channels
