...
// SendPacket is called by a module in order to send an ICP packet on a channel
...
// RecvPacket is called by a module in order to receive & process an ICP packet
...
// CONTRACT:
//
// 1) For synchronous execution, this function is be called in the ICP handler .
...
func (k Keeper) WriteAcknowledgement(
	...
	// NOTE: ICP app modules might have written the acknowledgement synchronously on
