...
func (suite *KeeperTestSuite) TestTimeoutPacket() {
	...
	for i, tc := range testCases {
		...
		suite.Run(fmt.Sprintf("Case %s, %d/%d tests", tc.msg, i, len(testCases)), func() {
			...
			err := suite.chainA.App.ICPKeeper.ChannelKeeper.TimeoutPacket(suite.chainA.GetContext(), packet, proof, proofHeight, nextSeqRecv)
...
func (suite *KeeperTestSuite) TestTimeoutExecuted() {
	...
	for i, tc := range testCases {
		...
		suite.Run(fmt.Sprintf("Case %s, %d/%d tests", tc.msg, i, len(testCases)), func() {
			...
			err := suite.chainA.App.ICPKeeper.ChannelKeeper.TimeoutExecuted(suite.chainA.GetContext(), chanCap, packet)
...
func (suite *KeeperTestSuite) TestTimeoutOnClose() {
	...
	for i, tc := range testCases {
		...
		suite.Run(fmt.Sprintf("Case %s, %d/%d tests", tc.msg, i, len(testCases)), func() {
			...
			err := suite.chainA.App.ICPKeeper.ChannelKeeper.TimeoutOnClose(suite.chainA.GetContext(), chanCap, packet, proof, proofClosed, proofHeight, nextSeqRecv)
