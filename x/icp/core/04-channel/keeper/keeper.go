...
import (
	...
	db "github.com/creatachain/tm-db"
...
// Keeper defines the ICP channel keeper
type Keeper struct {
...
// NewKeeper creates a new ICP channel Keeper instance
func NewKeeper(
...
// LookupModuleByChannel will return the ICPModule along with the capability associated with a given channel defined by its portID and channelID
