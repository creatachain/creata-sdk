...
func (k Keeper) ChanOpenInit(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "channel", "open-init")
	}()
...
func (k Keeper) ChanOpenTry(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "channel", "open-try")
	}()
...
func (k Keeper) ChanOpenAck(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "channel", "open-ack")
	}()
...
func (k Keeper) ChanOpenConfirm(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "channel", "open-confirm")
	}()
	return nil
}
...
func (k Keeper) ChanCloseInit(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "channel", "close-init")
	}()
...
func (k Keeper) ChanCloseConfirm(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "channel", "close-confirm")
	}()
