...
var (
	// DefaultICPVersion represents the latest supported version of ICP used
	...
	// to be agreed upon.
	DefaultICPVersion = NewVersion(DefaultICPVersionIdentifier, []string{"ORDER_ORDERED", "ORDER_UNORDERED"})

	// DefaultICPVersionIdentifier is the ICP v1.0.0 protocol version identifier
	DefaultICPVersionIdentifier = "1"
	...
	allowNilFeatureSet = map[string]bool{
		DefaultICPVersionIdentifier: false,
	}
)
...
// GetCompatibleVersions returns a descending ordered set of compatible ICP
...
func GetCompatibleVersions() []exported.Version {
	return []exported.Version{DefaultICPVersion}
}
...
// PickVersion iterates over the descending ordered set of compatible ICP
