...
const (
	// SubModuleName defines the ICP connection name
	SubModuleName = "connection"

	// StoreKey is the store key string for ICP connections
	StoreKey = SubModuleName

	// RouterKey is the message route for ICP connections
	RouterKey = SubModuleName

	// QuerierRoute is the querier route for ICP connections
...
// This is a SDK specific format not enforced by ICP protocol.
