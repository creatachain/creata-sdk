...
func TestConnectionValidateBasic(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid connection",
			types.ConnectionEnd{clientID, []*types.Version{icptesting.ConnectionVersion}, types.INIT, types.Counterparty{clientID2, connectionID2, commitmenttypes.NewMerklePrefix([]byte("prefix"))}, 500},
			true,
		},
		{
			"invalid client id",
			types.ConnectionEnd{"(clientID1)", []*types.Version{icptesting.ConnectionVersion}, types.INIT, types.Counterparty{clientID2, connectionID2, commitmenttypes.NewMerklePrefix([]byte("prefix"))}, 500},
			false,
		},
		{
			"empty versions",
		...
		},
		{
			...
			types.ConnectionEnd{clientID, []*types.Version{icptesting.ConnectionVersion}, types.INIT, types.Counterparty{clientID2, connectionID2, emptyPrefix}, 500},
			false,
		},
	}
...
func TestIdentifiedConnectionValidateBasic(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid connection",
			types.NewIdentifiedConnection(clientID, types.ConnectionEnd{clientID, []*types.Version{icptesting.ConnectionVersion}, types.INIT, types.Counterparty{clientID2, connectionID2, commitmenttypes.NewMerklePrefix([]byte("prefix"))}, 500}),
			true,
		},
		{
			"invalid connection id",
			types.NewIdentifiedConnection("(connectionIDONE)", types.ConnectionEnd{clientID, []*types.Version{icptesting.ConnectionVersion}, types.INIT, types.Counterparty{clientID2, connectionID2, commitmenttypes.NewMerklePrefix([]byte("prefix"))}, 500}),
			false,
		},
	}
