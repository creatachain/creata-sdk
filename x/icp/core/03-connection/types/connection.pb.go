...
// source: icp/core/connection/v1/connection.proto

package types

import (
	fmt "fmt"
	types "github.com/creatachain/creata-sdk/x/icp/core/23-commitment/types"
...
func (State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e5857899150f2cfa, []int{0}
}
...
type ConnectionEnd struct {
	...
	// ICP version which can be utilised to determine encodings or protocols for
	// channels or packets utilising this connection.
	Versions []*Version `protobuf:"bytes,2,rep,name=versions,proto3" json:"versions,omitempty"`
	// current state of the connection end.
	State State `protobuf:"varint,3,opt,name=state,proto3,enum=icp.core.connection.v1.State" json:"state,omitempty"`
...
type IdentifiedConnection struct {
	...
	// current state of the connection end.
	State State `protobuf:"varint,4,opt,name=state,proto3,enum=icp.core.connection.v1.State" json:"state,omitempty"`
	// counterparty chain associated with this connection.
...
func (*IdentifiedConnection) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5857899150f2cfa, []int{1}
}
...
func (*Counterparty) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5857899150f2cfa, []int{2}
}
...
func (*ClientPaths) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5857899150f2cfa, []int{3}
}
...
func (*ConnectionPaths) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5857899150f2cfa, []int{4}
}
...
// Version defines the versioning scheme used to negotiate the ICP verison in
...
func (*Version) Descriptor() ([]byte, []int) {
	return fileDescriptor_e5857899150f2cfa, []int{5}
}
...
func init() {
	proto.RegisterEnum("icp.core.connection.v1.State", State_name, State_value)
	proto.RegisterType((*ConnectionEnd)(nil), "icp.core.connection.v1.ConnectionEnd")
	proto.RegisterType((*IdentifiedConnection)(nil), "icp.core.connection.v1.IdentifiedConnection")
	proto.RegisterType((*Counterparty)(nil), "icp.core.connection.v1.Counterparty")
	proto.RegisterType((*ClientPaths)(nil), "icp.core.connection.v1.ClientPaths")
	proto.RegisterType((*ConnectionPaths)(nil), "icp.core.connection.v1.ConnectionPaths")
	proto.RegisterType((*Version)(nil), "icp.core.connection.v1.Version")
}

func init() {
	proto.RegisterFile("icp/core/connection/v1/connection.proto", fileDescriptor_e5857899150f2cfa)
}

var fileDescriptor_e5857899150f2cfa = []byte{
	// 657 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xac, 0x54, 0x41, 0x6b, 0xdb, 0x4c,
	0x14, 0xd4, 0xca, 0x72, 0x62, 0xaf, 0xe3, 0xef, 0x73, 0xb7, 0xa6, 0x15, 0x82, 0x48, 0x42, 0x2d,
	0xd4, 0x14, 0x62, 0xd5, 0x09, 0xf4, 0x90, 0x52, 0x68, 0xec, 0xb8, 0x20, 0xda, 0xba, 0x46, 0x71,
	0x0a, 0xf5, 0xc5, 0x28, 0xd2, 0x26, 0x59, 0x62, 0x4b, 0x42, 0xde, 0x98, 0xf8, 0x1f, 0x84, 0x9c,
	...
	,
}
