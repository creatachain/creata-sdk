...
func QueryConnection(
	...
	if prove {
		return queryConnectionMSM(clientCtx, connectionID)
	}
...
func queryConnectionMSM(clientCtx client.Context, connectionID string) (*types.QueryConnectionResponse, error) {
...
func QueryClientConnections(
	...
	if prove {
		return queryClientConnectionsMSM(clientCtx, clientID)
	}
...
func queryClientConnectionsMSM(clientCtx client.Context, clientID string) (*types.QueryClientConnectionsResponse, error) {
