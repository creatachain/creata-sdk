...
func (k Keeper) ConnOpenInit(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "connection", "open-init")
	}()
...
func (k Keeper) ConnOpenTry(
	...
	// with Chain B's supported ICP versions. PickVersion will select the intersection
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "connection", "open-try")
	}()
...
func (k Keeper) ConnOpenAck(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "connection", "open-ack")
	}()
...
func (k Keeper) ConnOpenConfirm(
	...
	defer func() {
		telemetry.IncrCounter(1, "icp", "connection", "open-confirm")
	}()
