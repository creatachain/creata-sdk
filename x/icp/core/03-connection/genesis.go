...
import (
	...
	"github.com/creatachain/creata-sdk/x/icp/core/03-connection/keeper"
	"github.com/creatachain/creata-sdk/x/icp/core/03-connection/types"
)

// InitGenesis initializes the icp connection submodule's state from a provided genesis
// state.
...
// ExportGenesis returns the icp connection submodule's exported genesis.
