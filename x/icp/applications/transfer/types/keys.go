...
const (
	// ModuleName defines the ICP transfer name
	ModuleName = "transfer"

	// Version defines the current version the ICP tranfer
	// module supports
	Version = "ics20-1"
	...
	// StoreKey is the store key string for ICP transfer
	StoreKey = ModuleName

	// RouterKey is the message route for ICP transfer
	RouterKey = ModuleName

	// QuerierRoute is the querier route for ICP transfer
...
// https://github.com/creatachain/creata-sdk/blob/master/docs/architecture/adr-028-public-key-addresses.md
