...
var (
	...
	coin             = sdk.NewCoin("cta", sdk.NewInt(100))
	icpCoin          = sdk.NewCoin("icp/7F1D3FCF4AE79E1554D670D1AD949A9BA4E4A3C76C63093E17E446A46061A7A2", sdk.NewInt(100))
	invalidICPCoin   = sdk.NewCoin("noticp/7F1D3FCF4AE79E1554D670D1AD949A9BA4E4A3C76C63093E17E446A46061A7A2", sdk.NewInt(100))
	invalidDenomCoin = sdk.Coin{Denom: "0cta", Amount: sdk.NewInt(100)}
	zeroCoin         = sdk.Coin{Denom: "ctas", Amount: sdk.NewInt(0)}
...
func TestMsgTransferGetSignBytes(t *testing.T) {
	msg := NewMsgTransfer(validPort, validChannel, coin, addr1, addr2, timeoutHeight, 0)
	expected := fmt.Sprintf(`{"type":"creata-sdk/MsgTransfer","value":{"receiver":"%s","sender":"%s","source_channel":"testchannel","source_port":"testportid","timeout_height":{"revision_height":"10"},"token":{"amount":"100","denom":"cta"}}}`, addr2, addr1)
...
func TestMsgTransferValidation(t *testing.T) {
	testCases := []struct {
		...
		{"valid msg with trace hash", NewMsgTransfer(validPort, validChannel, icpCoin, addr1, addr2, timeoutHeight, 0), true},
		{"invalid icp denom", NewMsgTransfer(validPort, validChannel, invalidICPCoin, addr1, addr2, timeoutHeight, 0), false},
