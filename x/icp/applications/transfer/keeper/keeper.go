...
// Keeper defines the ICP fungible transfer keeper
type Keeper struct {
...
// NewKeeper creates a new ICP transfer Keeper instance
func NewKeeper(
	...
	// ensure icp transfer module account is set
	if addr := authKeeper.GetModuleAddress(types.ModuleName); addr == nil {
		panic("the ICP transfer module account has not been set")
	}
...
// ClaimCapability allows the transfer module that can claim a capability that ICP module
// passes to it
