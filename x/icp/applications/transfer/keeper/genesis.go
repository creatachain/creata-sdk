...
// InitGenesis initializes the icp-transfer state and binds to PortID.
...
// ExportGenesis exports icp-transfer module's portID and denom trace info into its genesis state.
