...
// for both chains. The channels created are connected to the icp-transfer application.
func (coord *Coordinator) Setup(
	...
	clientA, clientB, connA, connB := coord.SetupClientConnections(chainA, chainB, exported.Augusteum)
...
// icp-transfer channels on chainA and chainB. The function expects the channels to be
// successfully opened otherwise testing will fail.
...
func (coord *Coordinator) SendPacket(
	...
	return coord.UpdateClient(
		counterparty, source,
		counterpartyClientID, exported.Augusteum,
	)
}
...
func (coord *Coordinator) ConnOpenTry(
	...
	return coord.UpdateClient(
		counterparty, source,
		counterpartyConnection.ClientID, exported.Augusteum,
	)
}
...
func (coord *Coordinator) ChanOpenInitOnBothChains(
	...
	if err := coord.UpdateClient(
		source, counterparty,
		connection.ClientID, exported.Augusteum,
	); err != nil {
		return sourceChannel, counterpartyChannel, err
	}
...
func (coord *Coordinator) ChanOpenTry(
	...
	return coord.UpdateClient(
		counterparty, source,
		connection.CounterpartyClientID, exported.Augusteum,
	)
}
...
func (coord *Coordinator) ChanOpenAck(
	...
	return coord.UpdateClient(
		counterparty, source,
		sourceChannel.CounterpartyClientID, exported.Augusteum,
	)
}
...
func (coord *Coordinator) ChanCloseInit(
	...
	return coord.UpdateClient(
		counterparty, source,
		channel.CounterpartyClientID, exported.Augusteum,
	)
}
...
func (coord *Coordinator) SetChannelClosed(
	...
	source.App.ICPKeeper.ChannelKeeper.SetChannel(source.GetContext(), testChannel.PortID, testChannel.ID, channel)
	...
	return coord.UpdateClient(
		counterparty, source,
		testChannel.CounterpartyClientID, exported.Augusteum,
	)
}
