...
// source: icp/lightclients/augusteum/v1/augusteum.proto
...
import (
	...
	types2 "github.com/creatachain/augusteum/proto/augusteum/types"
	types "github.com/creatachain/creata-sdk/x/icp/core/02-client/types"
	types1 "github.com/creatachain/creata-sdk/x/icp/core/23-commitment/types"
...
// ClientState from Augusteum tracks the current validator set, latest height,
...
type ClientState struct {
	...
	// For SDK chains using the default upgrade module, upgrade_path should be []string{"upgrade", "upgradedICPState"}`
...
func (*ClientState) Descriptor() ([]byte, []int) {
	return fileDescriptor_9abe362914f2bb94, []int{0}
}
...
// ConsensusState defines the consensus state from Augusteum.
type ConsensusState struct {
	...
	NextValidatorsHash github_com_creatachain_augusteum_libs_bytes.HexBytes `protobuf:"bytes,3,opt,name=next_validators_hash,json=nextValidatorsHash,proto3,casttype=github.com/creatachain/augusteum/libs/bytes.HexBytes" json:"next_validators_hash,omitempty" yaml:"next_validators_hash"`
}
...
func (*ConsensusState) Descriptor() ([]byte, []int) {
	return fileDescriptor_9abe362914f2bb94, []int{1}
}
...
func (*Misbehaviour) Descriptor() ([]byte, []int) {
	return fileDescriptor_9abe362914f2bb94, []int{2}
}
...
// Header defines the Augusteum client consensus Header.
// It encapsulates all the information necessary to update from a trusted
// Augusteum ConsensusState. The inclusion of TrustedHeight and
...
func (*Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_9abe362914f2bb94, []int{3}
}
...
func (*Fraction) Descriptor() ([]byte, []int) {
	return fileDescriptor_9abe362914f2bb94, []int{4}
}
...
func init() {
	proto.RegisterType((*ClientState)(nil), "icp.lightclients.augusteum.v1.ClientState")
	proto.RegisterType((*ConsensusState)(nil), "icp.lightclients.augusteum.v1.ConsensusState")
	proto.RegisterType((*Misbehaviour)(nil), "icp.lightclients.augusteum.v1.Misbehaviour")
	proto.RegisterType((*Header)(nil), "icp.lightclients.augusteum.v1.Header")
	proto.RegisterType((*Fraction)(nil), "icp.lightclients.augusteum.v1.Fraction")
}

func init() {
	proto.RegisterFile("icp/lightclients/augusteum/v1/augusteum.proto", fileDescriptor_9abe362914f2bb94)
}

var fileDescriptor_9abe362914f2bb94 = []byte{
	...
	,
}
...
func (m *ClientState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UpgradePath) > 0 {
		for iNdEx := len(m.UpgradePath) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAugusteum(dAtA, i, uint64(len(m.UpgradePath[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
		...
		for iNdEx := len(m.ProofSpecs) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintAugusteum(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x42
		}
	...
	i -= n3
	i = encodeVarintAugusteum(dAtA, i, uint64(n3))
	i--
	dAtA[i] = 0x2a
	...
	i -= n4
	i = encodeVarintAugusteum(dAtA, i, uint64(n4))
	i--
	dAtA[i] = 0x22
	...
	i -= n5
	i = encodeVarintAugusteum(dAtA, i, uint64(n5))
	i--
	dAtA[i] = 0x1a
	{
	...
	if len(m.ChainId) > 0 {
		...
		i = encodeVarintAugusteum(dAtA, i, uint64(len(m.ChainId)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *ConsensusState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NextValidatorsHash) > 0 {
		...
		i = encodeVarintAugusteum(dAtA, i, uint64(len(m.NextValidatorsHash)))
		i--
		dAtA[i] = 0x1a
	}
	{
	...
	i -= n8
	i = encodeVarintAugusteum(dAtA, i, uint64(n8))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *Misbehaviour) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ClientId) > 0 {
		...
		i = encodeVarintAugusteum(dAtA, i, uint64(len(m.ClientId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Fraction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Denominator != 0 {
		i = encodeVarintAugusteum(dAtA, i, uint64(m.Denominator))
		i--
		dAtA[i] = 0x10
	}
	if m.Numerator != 0 {
		i = encodeVarintAugusteum(dAtA, i, uint64(m.Numerator))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintAugusteum(dAtA []byte, offset int, v uint64) int {
	offset -= sovAugusteum(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Fraction) Size() (n int) {
	...
	_ = l
	if m.Numerator != 0 {
		n += 1 + sovAugusteum(uint64(m.Numerator))
	}
	if m.Denominator != 0 {
		n += 1 + sovAugusteum(uint64(m.Denominator))
	}
	return n
}

func sovAugusteum(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozAugusteum(x uint64) (n int) {
	return sovAugusteum(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *ClientState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowAugusteum
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthAugusteum
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipAugusteum(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipAugusteum(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowAugusteum
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthAugusteum
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupAugusteum
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthAugusteum        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowAugusteum          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupAugusteum = fmt.Errorf("proto: unexpected end of group")
)
