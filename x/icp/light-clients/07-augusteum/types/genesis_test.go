...
func (suite *AugusteumTestSuite) TestExportMetadata() {
	...
	suite.chainA.App.ICPKeeper.ClientKeeper.SetClientState(suite.chainA.GetContext(), "clientA", clientState)

	gm := clientState.ExportMetadata(suite.chainA.App.ICPKeeper.ClientKeeper.ClientStore(suite.chainA.GetContext(), "clientA"))
