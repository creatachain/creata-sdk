...
// checkProposedHeader checks if the Augusteum header is valid for updating a client after
// a passed proposal.
// It returns an error if:
// - the header provided is not parseable to augusteum types
// - header height is less than or equal to the latest client state height
// - signed augusteum header is invalid
