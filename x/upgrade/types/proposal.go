...
func init() {
	...
	gov.RegisterProposalTypeCodec(&SoftwareUpgradeProposal{}, "creata-sdk/SoftwareUpgradeProposal")
	gov.RegisterProposalType(ProposalTypeCancelSoftwareUpgrade)
	gov.RegisterProposalTypeCodec(&CancelSoftwareUpgradeProposal{}, "creata-sdk/CancelSoftwareUpgradeProposal")
}
