...
import (
	...
	gov "github.com/creatachain/creata-sdk/x/gov/types"
...
func NewCmdSubmitUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/creatachain/creata-sdk/tree/master/creatavisor",
