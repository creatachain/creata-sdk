...
func queryBalance(ctx sdk.Context, req msm.RequestQuery, k Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
...
func queryAllBalance(ctx sdk.Context, req msm.RequestQuery, k Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
...
func queryTotalSupply(ctx sdk.Context, req msm.RequestQuery, k Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
...
func querySupplyOf(ctx sdk.Context, req msm.RequestQuery, k Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
