...
func TestRandomizedGenState(t *testing.T) {
	...
	require.Equal(t, "creata1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", bankGenesis.Balances[2].GetAddress().String())
	require.Equal(t, "1000fcta", bankGenesis.Balances[2].GetCoins().String())
	require.Equal(t, "6000fcta", bankGenesis.Supply.String())
}
