...
func TestMsgDepositGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"creata-sdk/MsgDeposit","value":{"amount":[{"amount":"1000","denom":"ucta"}],"depositor":"creata1v9jxgu33kfsgr5","proposal_id":"0"}}`
...
func TestMsgSubmitProposal_GetSignBytes(t *testing.T) {
	...
	require.Equal(t,
		`{"type":"creata-sdk/MsgSubmitProposal","value":{"content":{"type":"creata-sdk/TextProposal","value":{"description":"abcd","title":"test"}},"initial_deposit":[]}}`,
		string(bz))
}
