...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&MsgSubmitProposal{}, "creata-sdk/MsgSubmitProposal", nil)
	cdc.RegisterConcrete(&MsgDeposit{}, "creata-sdk/MsgDeposit", nil)
	cdc.RegisterConcrete(&MsgVote{}, "creata-sdk/MsgVote", nil)
	cdc.RegisterConcrete(&TextProposal{}, "creata-sdk/TextProposal", nil)
}
