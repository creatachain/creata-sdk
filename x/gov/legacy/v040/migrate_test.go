...
func TestMigrate(t *testing.T) {
	...
	recipient, err := sdk.AccAddressFromBech32("creata1fl48vsnmsdzcv85q5d2q4z5ajdha8yu34mf0eh")
	...
	"proposals": [
		{
			"content": {
				"@type": "/creata.gov.v1beta1.TextProposal",
				"description": "bar_text",
				"title": "foo_text"
			},
		...
		{
			"content": {
				"@type": "/creata.distribution.v1beta1.CommunityPoolSpendProposal",
				"amount": [
					{
						"amount": "2",
						"denom": "footoken"
				...
				"description": "bar_community",
				"recipient": "creata1fl48vsnmsdzcv85q5d2q4z5ajdha8yu34mf0eh",
				"title": "foo_community"
			},
			"deposit_end_time": "0001-01-01T00:00:00Z",
			"final_tally_result": {
		...
		{
			"content": {
				"@type": "/creata.upgrade.v1beta1.CancelSoftwareUpgradeProposal",
				"description": "bar_cancel_upgrade",
				"title": "foo_cancel_upgrade"
			},
			"deposit_end_time": "0001-01-01T00:00:00Z",
		...
		{
			"content": {
				"@type": "/creata.upgrade.v1beta1.SoftwareUpgradeProposal",
				"description": "bar_software_upgrade",
				"plan": {
					"height": "123",
					"info": "foo_upgrade_info",
		...
		{
			"content": {
				"@type": "/creata.params.v1beta1.ParameterChangeProposal",
				"changes": [
					{
						"key": "foo_param_change_key",
						"subspace": "foo_param_change_subspace",
