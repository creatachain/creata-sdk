...
func queryParams(ctx sdk.Context, path []string, req msm.RequestQuery, keeper Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
	switch path[0] {
...
// nolint: unparam
func queryProposal(ctx sdk.Context, path []string, req msm.RequestQuery, keeper Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
...
// nolint: unparam
func queryDeposit(ctx sdk.Context, path []string, req msm.RequestQuery, keeper Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
...
// nolint: unparam
func queryVote(ctx sdk.Context, path []string, req msm.RequestQuery, keeper Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
...
// nolint: unparam
func queryDeposits(ctx sdk.Context, path []string, req msm.RequestQuery, keeper Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
	var params types.QueryProposalParams
	err := legacyQuerierCdc.UnmarshalJSON(req.Data, &params)
	if err != nil {
		return nil, sdkerrors.Wrap(sdkerrors.ErrJSONUnmarshal, err.Error())
...
// nolint: unparam
func queryTally(ctx sdk.Context, path []string, req msm.RequestQuery, keeper Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
	var params types.QueryProposalParams
	err := legacyQuerierCdc.UnmarshalJSON(req.Data, &params)
	if err != nil {
		return nil, sdkerrors.Wrap(sdkerrors.ErrJSONUnmarshal, err.Error())
...
// nolint: unparam
func queryVotes(ctx sdk.Context, path []string, req msm.RequestQuery, keeper Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
...
func queryProposals(ctx sdk.Context, _ []string, req msm.RequestQuery, keeper Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
