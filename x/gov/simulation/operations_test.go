...
func TestWeightedOperations(t *testing.T) {
	...
	expected := []struct {
		...
		{creataappparams.DefaultWeightMsgDeposit, types.ModuleName, types.TypeMsgDeposit},
		{creataappparams.DefaultWeightMsgVote, types.ModuleName, types.TypeMsgVote},
	}
...
func TestSimulateMsgSubmitProposal(t *testing.T) {
	...
	require.Equal(t, "creata1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.Proposer)
	require.Equal(t, "2686011fcta", msg.InitialDeposit.String())
...
func TestSimulateMsgDeposit(t *testing.T) {
	...
	require.Equal(t, "creata1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Depositor)
	require.Equal(t, "560969fcta", msg.Amount.String())
	require.Equal(t, "gov", msg.Route())
...
func TestSimulateMsgVote(t *testing.T) {
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, uint64(1), msg.ProposalId)
	require.Equal(t, "creata1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Voter)
