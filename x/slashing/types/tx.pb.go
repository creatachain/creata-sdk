...
// source: creata/slashing/v1beta1/tx.proto
...
func (*MsgUnjail) Descriptor() ([]byte, []int) {
	return fileDescriptor_4f78d9b897268b43, []int{0}
}
...
func (*MsgUnjailResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4f78d9b897268b43, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "creata.slashing.v1beta1.MsgUnjail")
	proto.RegisterType((*MsgUnjailResponse)(nil), "creata.slashing.v1beta1.MsgUnjailResponse")
}

func init() { proto.RegisterFile("creata/slashing/v1beta1/tx.proto", fileDescriptor_4f78d9b897268b43) }

var fileDescriptor_4f78d9b897268b43 = []byte{
	// 274 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x48, 0x2e, 0x4a, 0x4d,
	0x2c, 0x49, 0xd4, 0x2f, 0xce, 0x49, 0x2c, 0xce, 0xc8, 0xcc, 0x4b, 0xd7, 0x2f, 0x33, 0x4c, 0x4a,
	...
	0x1c, 0x4e, 0xd6, 0x83, 0x6b, 0x96, 0xd2, 0x22, 0xac, 0x06, 0x66, 0x81, 0x53, 0xc0, 0x8a, 0x47,
	...
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x0f, 0x31, 0x33, 0x39, 0x23, 0x31, 0x33, 0x0f,
	0xca, 0xd6, 0x2d, 0x4e, 0xc9, 0xd6, 0xaf, 0x40, 0x04, 0x6f, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12,
	0x1b, 0x38, 0xac, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xe0, 0x28, 0x8e, 0x5f, 0x7e, 0x01,
	0x00, 0x00,
}
...
func (c *msgClient) Unjail(ctx context.Context, in *MsgUnjail, opts ...grpc.CallOption) (*MsgUnjailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/creata.slashing.v1beta1.Msg/Unjail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Unjail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/creata.slashing.v1beta1.Msg/Unjail",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "creata.slashing.v1beta1.Msg",
	...
	Metadata: "creata/slashing/v1beta1/tx.proto",
}
