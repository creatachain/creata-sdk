...
func TestUnJailNotBonded(t *testing.T) {
	...
	addrDels := creataapp.AddTestAddrsIncremental(app, ctx, 6, sdk.TokensFromConsensusPower(200))
	valAddrs := creataapp.ConvertAddrsToValAddrs(addrDels)
	pks := creataapp.CreateTestPubKeys(6)
...
func TestHandleNewValidator(t *testing.T) {
	...
	addrDels := creataapp.AddTestAddrsIncremental(app, ctx, 1, sdk.TokensFromConsensusPower(200))
	valAddrs := creataapp.ConvertAddrsToValAddrs(addrDels)
...
func TestValidatorDippingInAndOut(t *testing.T) {
	...
	pks := creataapp.CreateTestPubKeys(3)
