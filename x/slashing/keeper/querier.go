...
func querySigningInfo(ctx sdk.Context, req msm.RequestQuery, k Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
...
func querySigningInfos(ctx sdk.Context, req msm.RequestQuery, k Keeper, legacyQuerierCdc *codec.LegacyAmino) ([]byte, error) {
