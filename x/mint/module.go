...
import (
	...
	"github.com/creatachain/creata-sdk/x/mint/client/cli"
	"github.com/creatachain/creata-sdk/x/mint/client/rest"
	"github.com/creatachain/creata-sdk/x/mint/keeper"
	"github.com/creatachain/creata-sdk/x/mint/simulation"
...
func (am AppModule) BeginBlock(ctx sdk.Context, _ msm.RequestBeginBlock) {
	BeginBlocker(ctx, am.keeper)
}

// EndBlock returns the end blocker for the mint module. It returns no validator
// updates.
func (AppModule) EndBlock(_ sdk.Context, _ msm.RequestEndBlock) []msm.ValidatorUpdate {
	return []msm.ValidatorUpdate{}
}
