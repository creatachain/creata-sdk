...
func randomConsensusParams(r *rand.Rand, appState json.RawMessage, cdc codec.JSONMarshaler) *msm.ConsensusParams {
	...
	consensusParams := &msm.ConsensusParams{
		...
		Validator: &tmproto.ValidatorParams{
			PubKeyTypes: []string{types.MSMPubKeyTypeEd25519},
		},
